...
## 13. [New Standard] Hollywood-K-Hybrid Engine (v7)
> 모든 이미지 생성 시 '클로드PM&홀리'가 반드시 준수해야 하는 최상위 렌더링 가이드라인.

### 13-1. [Optical & Physics Standards]

* **Lens Logic:** "(Anamorphic optical distortion:1.3), (Natural organic focal plane roll-off:1.4), (Non-linear depth of field blurring:1.5), (Fine hair strands melting into the bokeh:1.3)."

* **Artifacts:** "(Blue horizontal lens flares:1.4), (Subtle chromatic aberration:1.2), (Optical highlight bloom:1.3)."

### 13-2. [Skin & Aesthetic Defense]

* **Hybrid Skin:** "(Preserve pure alabaster white skin tone even under cinematic amber lights:1.5), (Subsurface scattering:1.5), (Zero-imperfection flawless dewy finish)."

* **Light Balance:** "Teal/Cool fill in shadows vs. Amber/Orange key light only on skin highlights (Anti-yellowing logic)."


### 13-3. [Shadow & Texture Logic]

* **Shadows:** "(Velvety heavily lifted shadows:1.4), (Faded film-lift black levels), (Low overall exposure:1.2)."

* **Grain:** "(Kodak Portra 400 emulation), (Fine organic film grain:1.2)."

### 13-4. [Advanced Prompt Assembly]
1. **Base Physics:** `Optical_Physics_Standards.md`의 Section 1(Physics) 최우선 로드.
2. **Color Science:** `Optical_Physics_Standards.md`의 Section 2(Color) 및 `FilmLook` 결합.
3. **Character Skin:** `Skin_Texture` 내 'IVE-Style' 데이터와 'Skin Defense' 로직 강제 결합.
